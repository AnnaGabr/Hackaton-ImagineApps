    ...
    <div className='notifContainer' id='principalForm'>
      <div className='cardDay'>
        <form className='alimentos-dia'>
          ...
          <p>
            ¡Recuerda!, aquí debes agregar los alimentos que preparaste hoy y no
            alcanzaste a vender. ¡Entre todos nos ayudamos!
          </p>
        </form>
        <AlimentosDia />
      </div>
      <div className='cardPerecederos'>
        <form className='alimentos-perecederos'>
          ...
          <p>
            ¡Recuerda!, aquí puedes agregar cualquier alimento que tenga una
            fecha de vencimiento pronta pero que no haya sido abierto, así
            podrás ofrecerlo a un buen precio. ¡Entre todos nos ayudamos!
          </p>
        </form>
